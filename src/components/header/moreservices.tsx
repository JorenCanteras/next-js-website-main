...
const services: ServiceItem[] = [
  {
    ...
    description:
      'Check if email is correct instantly with MailSentry’s rapid results. Our service ensures that every mail sent is effectively tracked, displaying progress and outcomes in real-time, so you can see if an email is valid as soon as you hit send.',
    imageUrl: 'https://mailsentry.io/_next/image?url=%2Ffeatures%2Freports-dashboard.avif&w=640&q=75',
    cta: 'Get Started',
  },
  {
